...
const Card = () => {
  return (
    <>
      <div className="tracking-wide p-6 backdrop-blur-sm bg-white/20  rounded-lg w-80 h-52 font-['Abel, sans-serif'] border-slate-200  border-[0.4px] shadow-md">
        <div className=" text-sm mt-2">{title_name} </div>
        <div className=" text-2xl mt-1">{current_amount}</div>
